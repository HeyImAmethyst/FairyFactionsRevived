...
//Class from https://github.com/MinecraftschurliMods/Ars-Magica-Legacy/blob/cc963bbd46959d749cacf96ca1a396a547b657bc/src/data/java/com/github/minecraftschurlimods/arsmagicalegacy/data/WorldgenProvider.java#L57
public abstract class WorldgenProvider //extends DatapackBuiltinEntriesProvider
{
...
//    {
//        super(output, registries, BUILDER, Collections.singleton(FairyFactions.MOD_ID));
//    }
//
...
//    }
//
//    protected void configuredFeature(ResourceLocation name, ConfiguredFeature<?, ?> cf)
//    {
//        cfs.put(name, cf);
//    }
//
//    protected void configuredFeature(String name, ConfiguredFeature<?, ?> cf)
//    {
//        configuredFeature(new ResourceLocation(namespace, name), cf);
//    }
//
//    protected void placedFeature(ResourceLocation name, PlacedFeature pf)
//    {
//        pfs.put(name, pf);
//    }
//
//    protected void placedFeature(String name, PlacedFeature pf)
//    {
//        placedFeature(new ResourceLocation(namespace, name), pf);
//    }
//
//    protected void biomeModifier(ResourceLocation name, BiomeModifier bm)
//    {
//        bms.put(name, bm);
//    }
//
//    protected void biomeModifier(String name, BiomeModifier bm)
//    {
//        biomeModifier(new ResourceLocation(namespace, name), bm);
//    }
//
//    protected Holder<ConfiguredFeature<?, ?>> configuredFeature(ResourceLocation name)
//    {
//        return getHolderOrThrow(Registry.CONFIGURED_FEATURE_REGISTRY, name);
//    }
//
//    protected Holder<ConfiguredFeature<?, ?>> configuredFeature(String name)
//    {
//        return configuredFeature(new ResourceLocation(namespace, name));
//    }
//
//    protected Holder<PlacedFeature> placedFeature(ResourceLocation name)
//    {
//        return getHolderOrThrow(Registry.PLACED_FEATURE_REGISTRY, name);
//    }
//
//    protected Holder<PlacedFeature> placedFeature(String name) {
//        return placedFeature(new ResourceLocation(namespace, name));
//    }
//
//    protected HolderSet<Biome> biomeTag(TagKey<Biome> tag)
//    {
...
//        if (holders.length == 1)
//        {
//            return new NotHolderSet<>(registryOrThrow(Registry.BIOME_REGISTRY), holders[0]);
//        }
//        else
//        {
